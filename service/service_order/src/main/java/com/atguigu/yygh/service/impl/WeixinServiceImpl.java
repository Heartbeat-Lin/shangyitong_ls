...
public class WeixinServiceImpl implements WeixinService {
    ...
    public Map createNative(Long orderId) {
        ...
        try {
            ...
            if(null != payMap) return payMap;   //如果map在redis缓存中能查到，则直接返回就行
            ...
            paramMap.put("total_fee", "1"); //为了测试统一写成这个值表示0.01元
            ...
            map.put("codeUrl", resultMap.get("code_url")); //二维码地址，这是最重要的一个值
